...
define('resources/elements/treemenu',["require", "exports", 'aurelia-framework', 'aurelia-router', '../../services/registry'], function (require, exports, aurelia_framework_1, aurelia_router_1, registry_1) {
    "use strict";
    var Treemenu = (function () {
        ...
        Treemenu.prototype.click = function (event) {
            var link = event.target.closest('a'), submenu = link.parentNode.querySelector('ul');
            if (submenu) {
                event.preventDefault();
